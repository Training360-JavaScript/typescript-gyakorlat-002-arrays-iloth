export default class calculator {
    ...
    users: { name: string,  email: string }[] = [
        { name: 'Jani', email: 'jani@feri.hu'},
        { name: 'Feri', email: 'feri@jani.hu'},
    ];
    ...
    products: { name: string, price: number, stock: number, active?: boolean }[] = [
        { name: "Gumicsont", price: 100, stock: 0, active: true },
        { name: "Fabatka", price: 0, stock: 1000 }
    ];
     ...
     */
    role: [number, string, boolean] = [0, 'admin', true];
